...
public func instance()-> PulleyViewController?{
    let storyboard = UIStoryboard(name: "AthleteDashboard", bundle: nil)
    let controller = storyboard.instantiateViewController(withIdentifier: "PulleyViewController") as? PulleyViewController
    return controller
}
/**
