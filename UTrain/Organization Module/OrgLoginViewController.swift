...
class OrgLoginViewController: UIViewController {
    ...
    class func instance()-> OrgLoginViewController?{
        let storyboard = UIStoryboard(name: "OrganizationModule", bundle: nil)
        let controller = storyboard.instantiateViewController(withIdentifier: "OrgLoginViewController") as? OrgLoginViewController
        return controller
    }
    ...
    @IBAction func signupAction(_ sender: Any) {
        guard let controller = OrgSignUpViewController.instance() else{
            return
        }
        self.navigationController?.pushViewController(controller, animated: true)
